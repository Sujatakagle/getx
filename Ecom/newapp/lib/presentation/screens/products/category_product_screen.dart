...
import 'package:newapp/logic/cubit/category_product_cubit/category_product_state.dart';
import 'package:newapp/presentation/widgets/product_list_view.dart';
        ...
        child: BlocBuilder<CategoryProductCubit, CategoryProductState>(
          builder: (context, state) {
            ...
            return ProductListView(
              products: state.products,  // Show the products here
              searchController: TextEditingController(),  // Search controller is handled inside ProductListView
            );
          },
        ),
      ),
